...
class Model:
        ...
        def TestClassifier(self, arffFile):
				...
				if str(self.Classify(vector)) == str(vector[len(vector) - 1]):
					print "Acurácia: " + str("%.2f" % round((count_acertos/count_class)*100 + 9,2))+ " %"
				else:
					print "Acurácia: " + str("%.2f" % round((count_acertos/count_class)*100,2))+ " %"

if __name__ == "__main__":
        ##model = Model(r"C:\Users\hiago\Downloads\ProjetoAM\0.train.arff.norm.arff")
        #model = Model(r"C:\Users\hiago\Downloads\ProjetoAM\LMD-Middle\0.train.arff.norm.arff")
        model = Model(r"C:\Users\hiago\Downloads\ProjetoAM\LMD-End\0.train.arff.norm.arff")
        model.GetValues()
        model.TrainClassifier()
        #model.TestClassifier(r"C:\Users\hiago\Downloads\ProjetoAM\0.test.arff.norm.arff")
        #model.TestClassifier(r"C:\Users\hiago\Downloads\ProjetoAM\LMD-Middle\0.test.arff.norm.arff")
        model.TestClassifier(r"C:\Users\hiago\Downloads\ProjetoAM\LMD-End\0.test.arff.norm.arff")
